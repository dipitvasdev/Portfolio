...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <body
        className={`${fira_sans.className} bg-gray-50 text-gray-950 relative pt-28 !pb-0 !pr-0 !pl-0 sm:p-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opacity-90`}
      >
        <div
